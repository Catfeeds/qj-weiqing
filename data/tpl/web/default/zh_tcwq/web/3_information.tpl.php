        ...
        <form action="" method="get" class="col-md-3">
          ...
          <input type="hidden" name="do" value="information" />
            <div class="input-group" style="width: 300px">
                <input type="text" name="keywords" class="form-control" value="<?php  echo $_GPC['keywords'];?>" placeholder="请输入帖子联系人名称/电话/内容">
        ...
        <div class="panel-body" style="padding: 0px 15px;">
                    ...
                    <tr class="yg5_tr2">
                       ...
                       <!--  <td><?php  if($item['hot']==1) { ?><span class="label label-info">是</span><?php  } else { ?>否<?php  } ?></td> -->
                        ...
                        <?php  } ?></td>
                          ...
                          <td><?php  if($item['dq_time']) { ?><?php  echo date("Y-m-d",$item['dq_time'])?><?php  } ?></td>
                   ...
                   <div class="modal fade" id="myModal<?php  echo $item['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="<?php  echo $this->createWebUrl('information', array('op' => 'delete', 'id' => $item['id']))?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="myModala<?php  echo $item['user_id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl('information', array('op' => 'defriend', 'id' => $item['user_id']))?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
