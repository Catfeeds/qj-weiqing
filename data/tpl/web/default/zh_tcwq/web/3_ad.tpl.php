                ...
                <table class="yg5_tabel col-md-12">
                    ...
                    <tr class="yg5_tr2">
                      ...
                      <!--   <td><div class="type-parent"><?php  echo $row['src'];?>&nbsp;&nbsp;</div></td> -->
                         <td><div class="type-parent"><?php  if($row['type']==1) { ?>首页幻灯片<?php  } else if($row['type']==2) { ?>商家页面幻灯片<?php  } else if($row['type']==3) { ?>资讯页面幻灯片<?php  } else if($row['type']==4) { ?>拼车页面幻灯片<?php  } else if($row['type']==5) { ?>开屏广告<?php  } else if($row['type']==6) { ?>黄页广告<?php  } else if($row['type']==7) { ?>首页广告位<?php  } else if($row['type']==8) { ?>分类广告位<?php  } else if($row['type']==9) { ?>积分商城广告位<?php  } else if($row['type']==10) { ?>首页中部广告位<?php  } else if($row['type']==11) { ?>活动中心广告位<?php  } ?></div></td>
