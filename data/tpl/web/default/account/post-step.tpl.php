	...
	<div class="account-list-add-step">
		...
		<form action="" method="post" class="we7-form" enctype="multipart/form-data" id="js-account-post-step2" ng-controller="AccountPostStepTwo" ng-cloak>
			...
			<div class="form-group">
				...
				<div class="form-controls col-sm-8">
					<p class="form-control-static">在微信公众号请求用户网页授权之前，开发者需要先到公众平台网站的【开发者中心】<b>网页服务</b>中配置授权回调域名。<?php  if($_W['isfounder']) { ?><a href="http://www.wei8848.com/manual/dev:v0.6:qa:mobile_redirect_url_error" class="color-default" target="_black">查看详情</a><?php  } ?></p>
				</div>
			</div>
			<div class="form-group">
