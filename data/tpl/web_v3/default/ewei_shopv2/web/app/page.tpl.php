    ...
    <form action="./index.php">
                ...
                <div class="input-group">
                    <span class="input-group-select">
                        <select name="type" class="form-control  input-sm select2" style="width:120px;">
                            ...
                            <option value="20" <?php  if($_GPC['type']==20) { ?>selected<?php  } ?>>自定义</option>
                            <option value="3" <?php  if($_GPC['type']==3) { ?>selected<?php  } ?>>会员中心</option>
                            <option value="4" <?php  if($_GPC['type']==4) { ?>selected<?php  } ?>>商品详情</option>
                        </select>
                    </span>
        ...
        <ul class="nav nav-arrow-next nav-tabs" id="myTab" >
            ...
            <li class="<?php  if($_GPC['type']==4) { ?>active<?php  } ?>" >
                <a href="<?php  echo webUrl('app/page',array('type'=>4))?>">商品详情</a>
            </li>
            <li class="<?php  if($_GPC['type']==3) { ?>active<?php  } ?>" >
                <a href="<?php  echo webUrl('app/page',array('type'=>3))?>">会员中心</a>
            </li>
            <li class="<?php  if($_GPC['type']==20) { ?>active<?php  } ?>" >
                <a href="<?php  echo webUrl('app/page',array('type'=>20))?>">自定义</a>
            </li>
            ...
            <?php  if(is_array($list)) { foreach($list as $row) { ?>
                <tr>
                    ...
                    <td style="text-align: center;">
                        ...
                        <span class="label label-warning wid" >自定义</span>
                        <?php  } else if($row['type'] == 3) { ?>
                        <span class="label label-primary wid">会员中心</span>
                        <?php  } else if($row['type'] == 4) { ?>
                        <span class="label label-danger wid">商品详情</span>
                        <?php  } ?>
                    </td>
                    <td style="text-align: center;">
